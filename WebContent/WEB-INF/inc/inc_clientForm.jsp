...
<fieldset>
    ...
    <span class="erreur">${clientForm.erreurs['telephoneClient']}</span>
    <br />
     
    <label for="emailClient">Adresse email</label>
    <input type="email" id="emailClient" name="emailClient" value="<c:out value="${client.mail }" />" size="20" maxlength="60" />
    <span class="erreur">${clientForm.erreurs['emailClient']}</span>
    <br />
</fieldset>