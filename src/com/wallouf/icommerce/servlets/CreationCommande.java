...
public class CreationCommande extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("nomClient") == null || request.getParameter("nomClient").isEmpty() || request.getParameter("adresseClient") == null
				...
				|| request.getParameter("montantCommande") == null || request.getParameter("montantCommande").isEmpty()
				|| request.getParameter("modePaiementCommande") == null || request.getParameter("modePaiementCommande").isEmpty() || request.getParameter("modeLivraisonCommande") == null || request.getParameter("modeLivraisonCommande").isEmpty()){
